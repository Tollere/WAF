...
var fs = require('fs'), net = require('net'), path = require('path'), mkdirp = require('mkdirp').mkdirp;
...
exports.nextSocket = function (socketPath){
  var dir = path.dirname(socketPath), name = path.basename(socketPath,
                                                           '.sock'), match = name.match(/^([a-zA-z]+)(\d*)$/i), index = parseInt(match[2]), base = match[1];

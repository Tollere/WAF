...
var assert = require('assert'), exec = require('child_process').exec, fs = require('fs'), path = require('path'), vows = require('vows'), pkginfo = require('../lib/pkginfo');
                                    ...
                                    "When using the pkginfo module" : {
                                      ...
                                      "and passed no arguments"                : testExposes({
                                                                                               ...
                                                                                               assert : function (exposed){
                                                                                                 var pkg = fs.readFileSync(path.join(__dirname,
                                                                                                                                     '..',
                                                                                                                                     'examples',
                                                                                                                                     'package.json')).toString(), keys = Object.keys(JSON.parse(pkg));

                                                                                                 assertProperties(exposed,
                                                                                                                  keys);
                                                                                               }
                                                                                             })
                                    }

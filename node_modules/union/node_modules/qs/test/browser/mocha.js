 ...
 */
    ...
    function Mocha(options){
      options = options || {};
      options.grep = 'string' == typeof options.grep ? new RegExp(options.grep) : options.grep;
      this.files = [];
    ...
    Mocha.prototype.grep = function (re){
      this.options.grep = 'string' == typeof re ? new RegExp(re) : re;
      return this;
    };
  ...
  require.register("reporters/html.js", function (module, exports, require){
    ...
    var statsTemplate = '<ul id="stats">' + '<li class="progress"><canvas width="40" height="40"></canvas></li>' +
  ...
  require.register("reporters/json-cov.js", function (module, exports, require){
    ...
    function coverage(filename, data){
      ...
      data.source.forEach(function (line, num){
        ...
        ret.source[num] = {
          source : line, coverage : data[num] === undefined ? '' : data[num]
        };
      });
    ...
    function XUnit(runner){
      ...
      runner.on('end', function (){
        console.log(tag('testsuite', {
          name : 'Mocha Tests', tests : stats.tests, failures : stats.failures, errors : stats.failures, skip : stats.tests -
                                                                                                                stats.failures -
                                                                                                                stats.passes, timestamp : (new Date).toUTCString(), time : stats.duration /
                                                                                                                                                                           1000
        }, false));
...
// boot
  ...
  (function (){
    ...
    function highlight(js){
      return js.replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\/\/(.*)/gm,
                                                                    '<span class="comment">//$1</span>').replace(/('.*?')/gm,
                                                                                                                 '<span class="string">$1</span>').replace(/(\d+\.\d+)/gm,
                                                                                                                                                           '<span class="number">$1</span>').replace(/(\d+)/gm,
                                                                                                                                                                                                     '<span class="number">$1</span>').replace(/\bnew *(\w+)/gm,
                                                                                                                                                                                                                                               '<span class="keyword">new</span> <span class="init">$1</span>').replace(/\b(function|new|throw|return|var|if|else)\b/gm,

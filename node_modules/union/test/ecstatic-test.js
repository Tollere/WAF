...
var assert = require('assert'), ecstatic = require('ecstatic')(__dirname +
                                                               '/fixtures/static'), request = require('request'), vows = require('vows'), union = require('../');
...
vows.describe('union/ecstatic').addBatch({
                                           "When using union with ecstatic" : {
                                             ...
                                             "a request to /some-file.txt"                  : {
                                               topic                               : function (){
                                                 request({ uri : 'http://localhost:18082/some-file.txt' },
                                                         this.callback);
                                               },

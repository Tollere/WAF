...
function testfloat(){
  ...
  mod_ctype.wfloat(-2.4010576103645774e+38, 'big', buffer, 0);
  ASSERT.equal(0xff, buffer[0]);
  ASSERT.equal(0x34, buffer[1]);
  ASSERT.equal(0xa2, buffer[2]);
  ASSERT.equal(0xb0, buffer[3]);
  mod_ctype.wfloat(-2.4010576103645774e+38, 'little', buffer, 0);
  ASSERT.equal(0xff, buffer[3]);
  ...
  mod_ctype.wfloat(3.6468792534053364e-40, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ASSERT.equal(0x03, buffer[1]);
  ASSERT.equal(0xf8, buffer[2]);
  ASSERT.equal(0x9a, buffer[3]);
  mod_ctype.wfloat(3.6468792534053364e-40, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[3]);
  ...
  mod_ctype.wfloat(3.4028234663852886e+38, 'big', buffer, 0);
  ASSERT.equal(0x7f, buffer[0]);
  ASSERT.equal(0x7f, buffer[1]);
  ASSERT.equal(0xff, buffer[2]);
  ASSERT.equal(0xff, buffer[3]);
  mod_ctype.wfloat(3.4028234663852886e+38, 'little', buffer, 0);
  ASSERT.equal(0x7f, buffer[3]);
  ...
  mod_ctype.wfloat(1.1754943508222875e-38, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ASSERT.equal(0x80, buffer[1]);
  ASSERT.equal(0x00, buffer[2]);
  ASSERT.equal(0x00, buffer[3]);
  mod_ctype.wfloat(1.1754943508222875e-38, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[3]);
  ASSERT.equal(0x80, buffer[2]);
  ASSERT.equal(0x00, buffer[1]);
  ASSERT.equal(0x00, buffer[0]);
  ...
  mod_ctype.wfloat(1.401298464324817e-45, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ASSERT.equal(0x00, buffer[1]);
  ASSERT.equal(0x00, buffer[2]);
  ASSERT.equal(0x01, buffer[3]);
  mod_ctype.wfloat(1.401298464324817e-45, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[3]);
  ASSERT.equal(0x00, buffer[2]);
  ASSERT.equal(0x00, buffer[1]);
  ASSERT.equal(0x01, buffer[0]);
  ...
  mod_ctype.wfloat(1.1754942106924411e-38, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ASSERT.equal(0x7f, buffer[1]);
  ASSERT.equal(0xff, buffer[2]);
  ASSERT.equal(0xff, buffer[3]);
  mod_ctype.wfloat(1.1754942106924411e-38, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[3]);
  ASSERT.equal(0x7f, buffer[2]);
  ASSERT.equal(0xff, buffer[1]);
  ASSERT.equal(0xff, buffer[0]);
  ...
  buffer = new Buffer(6);
  mod_ctype.wfloat(-1.2027516403607578e-32, 'big', buffer, 2);
  ASSERT.equal(0x8a, buffer[2]);
  ASSERT.equal(0x79, buffer[3]);
  ASSERT.equal(0xcd, buffer[4]);
  ASSERT.equal(0x3f, buffer[5]);

  mod_ctype.wfloat(-1.2027516403607578e-32, 'little', buffer, 2);
...
function testdouble(){
  ...
  /* pos inf */
  mod_ctype.wdouble(Number.POSITIVE_INFINITY, 'big', buffer, 0);
  ASSERT.equal(0x7f, buffer[0]);
  ASSERT.equal(0xf0, buffer[1]);
  ASSERT.equal(0x00, buffer[2]);
  ASSERT.equal(0x00, buffer[3]);
  ...
  ASSERT.equal(0x00, buffer[6]);
  ASSERT.equal(0x00, buffer[7]);
  mod_ctype.wdouble(Number.POSITIVE_INFINITY, 'little', buffer, 0);
  ASSERT.equal(0x7f, buffer[7]);
  ASSERT.equal(0xf0, buffer[6]);
  ASSERT.equal(0x00, buffer[5]);
  ASSERT.equal(0x00, buffer[4]);
  ...
  /* neg inf */
  mod_ctype.wdouble(Number.NEGATIVE_INFINITY, 'big', buffer, 0);
  ASSERT.equal(0xff, buffer[0]);
  ASSERT.equal(0xf0, buffer[1]);
  ASSERT.equal(0x00, buffer[2]);
  ASSERT.equal(0x00, buffer[3]);
  ...
  ASSERT.equal(0x00, buffer[6]);
  ASSERT.equal(0x00, buffer[7]);
  mod_ctype.wdouble(Number.NEGATIVE_INFINITY, 'little', buffer, 0);
  ...
  /* +/- 1.125 */
  mod_ctype.wdouble(1.125, 'big', buffer, 0);
  ASSERT.equal(0x3f, buffer[0]);
  ...
  mod_ctype.wdouble(1.125, 'little', buffer, 0);
  ...
  mod_ctype.wdouble(1.4397318913736026e+283, 'big', buffer, 0);
  ...
  mod_ctype.wdouble(1.4397318913736026e+283, 'little', buffer, 0);
  ...
  mod_ctype.wdouble(8.82521232268344e-309, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ...
  mod_ctype.wdouble(8.82521232268344e-309, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[7]);
  ...
  mod_ctype.wdouble(5e-324, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ASSERT.equal(0x00, buffer[1]);
  ASSERT.equal(0x00, buffer[2]);
  ASSERT.equal(0x00, buffer[3]);
  ...
  mod_ctype.wdouble(5e-324, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[7]);
  ASSERT.equal(0x00, buffer[6]);
  ASSERT.equal(0x00, buffer[5]);
  ASSERT.equal(0x00, buffer[4]);
  ...
  mod_ctype.wdouble(2.225073858507201e-308, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ...
  mod_ctype.wdouble(2.225073858507201e-308, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[7]);
  ...
  mod_ctype.wdouble(2.2250738585072014e-308, 'big', buffer, 0);
  ASSERT.equal(0x00, buffer[0]);
  ...
  mod_ctype.wdouble(2.2250738585072014e-308, 'little', buffer, 0);
  ASSERT.equal(0x00, buffer[7]);
  ...
  mod_ctype.wdouble(1.7976931348623157e+308, 'big', buffer, 0);
  ASSERT.equal(0x7f, buffer[0]);
  ...
  mod_ctype.wdouble(1.7976931348623157e+308, 'little', buffer, 0);
  ASSERT.equal(0x7f, buffer[7]);
  ...
  mod_ctype.wdouble(-0.000015130017658081283, 'big', buffer, 2);
  ...
  mod_ctype.wdouble(-0.000015130017658081283, 'little', buffer, 2);

...
hawk.client = {
  ...
  header : function (uri, method, options){
    ...
    var header = 'Hawk id="' + credentials.id + '", ts="' + artifacts.ts + '", nonce="' + artifacts.nonce +
                 (artifacts.hash ? '", hash="' + artifacts.hash : '') +
                 (hasExt ? '", ext="' + hawk.utils.escapeHeaderAttribute(artifacts.ext) : '') + '", mac="' + mac + '"';
...
(function (){
  var k = CryptoJS, b = k.lib, m = b.WordArray, l = b.Hasher, d = [], b = k.algo.SHA1 =
                                                                          l.extend({ _doReset : function (){
                                                                            ...
                                                                            var b = this._data, d = b.words, a = 8 *
                                                                                                                 this._nDataBytes, e = 8 *
                                                                                                                                       b.sigBytes;
                                                                            d[e >>> 5] |= 128 << 24 - e % 32;
                                                                            d[(e + 64 >>> 9 << 4) + 14] =
  ...
  var n = [], h = h.SHA256 = j.extend({ _doReset : function (){
    ...
    for (var a = this._hash.words, c = a[0], d = a[1], b = a[2], k = a[3], f = a[4], g = a[5], j = a[6], l = a[7], e = 0;
      ...
      if (16 > e){
        ...
        n[e] = ((m << 25 | m >>> 7) ^ (m << 14 | m >>> 18) ^ m >>> 3) + n[e - 7] +
               ((p << 15 | p >>> 17) ^ (p << 13 | p >>> 19) ^ p >>> 10) + n[e - 16]
      }
  ...
  h.enc.Base64 = {stringify : function (b){
    ...
    for (var a = 0; a < f; a += 3){
      for (var d = (e[a >>> 2] >>> 24 - 8 * (a % 4) & 255) << 16 |
                   ...
                   e[a + 2 >>> 2] >>> 24 - 8 * ((a + 2) % 4) & 255, g = 0; 4 > g && a + 0.75 * g < f; g++){

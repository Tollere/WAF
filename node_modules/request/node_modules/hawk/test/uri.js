    ...
    it('should generate a bewit then successfully authenticate it', function (done){
      ...
      credentialsFunc('123456', function (err, credentials){
        ...
        var bewit = Hawk.uri.getBewit('http://example.com/resource/4?a=1&b=2',
                                      { credentials : credentials, ttlSec : 60 * 60 * 24 * 365 *
                                                                            100, ext : 'some-app-data' });
        req.url += '&bewit=' + bewit;
  ...
  describe('#getBewit', function (){
    ...
    it('should return a valid bewit value', function (done){
      ...
      var bewit = Hawk.uri.getBewit('https://example.com/somewhere/over/the/rainbow',
                                    { credentials : credentials, ttlSec : 300, localtimeOffsetMsec : 1356420407232 -
                                                                                                     Hawk.utils.now(), ext : 'xandyandz' });

  ...
  it('should generate a header then successfully parse it (node request)', function (done){
    ...
    credentialsFunc('123456', function (err, credentials){
      ...
      var reqHeader = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method,
                                            { credentials : credentials, ext : 'some-app-data', payload : payload, contentType : req.headers['content-type'] });
    ...
    describe('#header', function (){
      ...
      it('should return a valid authorization header (sha1)', function (done){
        ...
        var header = Browser.client.header('http://example.net/somewhere/over/the/rainbow', 'POST',
                                           { credentials : credentials, ext : 'Bazinga!', timestamp : 1353809207, nonce : 'Ygvqdz', payload : 'something to write about' }).field;
      ...
      it('should return a valid authorization header (sha256)', function (done){
        ...
        var header = Browser.client.header('https://example.net/somewhere/over/the/rainbow', 'POST',
                                           { credentials : credentials, ext : 'Bazinga!', timestamp : 1353809207, nonce : 'Ygvqdz', payload : 'something to write about', contentType : 'text/plain' }).field;
      ...
      it('should return a valid authorization header (no ext)', function (done){
        ...
        var header = Browser.client.header('https://example.net/somewhere/over/the/rainbow', 'POST',
                                           { credentials : credentials, timestamp : 1353809207, nonce : 'Ygvqdz', payload : 'something to write about', contentType : 'text/plain' }).field;
      ...
      it('should return an empty authorization header on invalid algorithm', function (done){
        ...
        var header = Browser.client.header('https://example.net/somewhere/over/the/rainbow', 'POST',
                                           { credentials : credentials, payload : 'something, anything!', ext : 'Bazinga!', timestamp : 1353809207 }).field;
        expect(header).to.equal('');
        done();
      });
    });

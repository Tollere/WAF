...
exports.formatStack = function (stack){
  ...
  for (var i = 0, il = stack.length; i < il; ++i){
    var item = stack[i];
    trace.push(
      [item.getFileName(), item.getLineNumber(), item.getColumnNumber(), item.getFunctionName(), item.isConstructor()]);
  }
...
exports.toss = function (condition /*, [message], next */){
  ...
  var err = (message instanceof Error ? message :
             (message ? new Error(message) : (condition instanceof Error ? condition : new Error())));
...
exports.printEvent = function (event){
  ...
  var timestring = (now.getYear() - 100).toString() + pad(now.getMonth() + 1) + pad(now.getDate()) + '/' +
